...
%To still advance as far in time as the L-simulation, the H-simulation performs two physics calculations.
%Because of this, H needs to calculate physics twice for every L physics calculation. 
...
%%%%%%%%
%In SPH particles with lower forces and velocities can have a higher time step without causing instabilities, since they move a shorter distance and are therefore less likely to end up in an unstable position. 
...
% TODO : Give better explanation why we expand.
